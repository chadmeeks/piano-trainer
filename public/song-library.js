window.PIANO_TRAINER_SONG_LIBRARY = {
  C: [
    {
      id: "let-it-be",
      title: "Let It Be",
      ...
      credits: [
        ...
        "Training chart: simplified C-major progression"
      ],
      songKey: "C Major",
      timeSignature: "4/4",
      ...
      youtubeCandidates: [
        { videoId: "QDYfEBY9NM4", title: "The Beatles - Let It Be", channel: "The Beatles", viewCount: 640000000 },
        { videoId: "CGj85pVzRJs", title: "Let It Be (Remastered 2009)", channel: "The Beatles - Topic", viewCount: 160000000 },
        { videoId: "dzM2AnqfYlE", title: "Let It Be - Live", channel: "The Beatles", viewCount: 52000000 }
      ],
      chartStartSec: 0.0,
      secondsPerBar: 3.4,
      ...
      sectionSpecs: [
        ...
        },
        {
          ...
          ,
            { chord: "Am", roman: "vi", inversion: "1st", lyric: "Let it be" },
            { chord: "G", roman: "V", inversion: "1st", lyric: "let it be" },
            { chord: "F", roman: "IV", inversion: "1st", lyric: "Whisper words" },
            { chord: "C", roman: "I", inversion: "root", lyric: "of wisdom" },
            { chord: "C", roman: "I", inversion: "root", lyric: "Let it be" },
            { chord: "G", roman: "V", inversion: "1st", lyric: "" },
            { chord: "F", roman: "IV", inversion: "1st", lyric: "" },
            { chord: "C", roman: "I", inversion: "root", lyric: "" }
        ...
        },
        {
          ...
          bars: [
            { chord: "Am", roman: "vi", inversion: "1st", lyric: "Let it be" },
            { chord: "G", roman: "V", inversion: "1st", lyric: "let it be" },
            { chord: "F", roman: "IV", inversion: "1st", lyric: "let it be, yeah" },
            { chord: "C", roman: "I", inversion: "root", lyric: "let it be" },
            { chord: "C", roman: "I", inversion: "root", lyric: "Whisper words" },
            { chord: "G", roman: "V", inversion: "1st", lyric: "of wisdom" },
            { chord: "F", roman: "IV", inversion: "1st", lyric: "let it be" },
